...
function addTask(projectName, title, description, dueDate, priority) {
  ...
  projects[projectName].push(
    _task_js__WEBPACK_IMPORTED_MODULE_0__["default"].createTask(title, description, dueDate, priority)
  );
  //save
...
function popTaskEditor(taskIndex) {
  ...
  doneBtn.addEventListener("click", (event) => {
    //edit
    if (taskIndex + 1) {
      _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].editTask(
        currentProject,
        taskIndex,
        title.value,
        description.value,
      ...
      _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTask(
        currentProject,
        title.value,
        description.value,
        deuDate.value,
  ...
  //edit
  if (taskIndex + 1) {
    let task = _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTask(currentProject, taskIndex);
    title.value = task.title;
    description.value = task.description;
    deuDate.value = task.dueDate //check empty dates
      ? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate, "yyyy-MM-dd")
      : "No date";
...
function finishTask(taskDiv) {
  ...
  //remove
  _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].removeTask(currentProject, taskIndex);
  showAllTasks(currentProject);
}
...
function popNewProject() {
  ...
  addBtn.addEventListener("click", () => {
    //alert
    if (_data_js__WEBPACK_IMPORTED_MODULE_0__["default"].getAllTasks(projectName.value)) {
    ...
    _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(projectName.value);
    showAllProjects();
    //close
    document.querySelector("#new-project-window").remove();
  });
...
function showAllProjects() {
  ...
  let projects = _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].getAllProjects();
  ...
  Object.keys(projects).forEach((project) => {
    ...
    removeProjectBtn.addEventListener("click", () => {
      if (confirm(`Are you sure you want delete ${currentProject}`)) {
        //remove
        _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].removeProject(currentProject);
...
function showAllTasks(project) {
  ...
  //task element
  _data_js__WEBPACK_IMPORTED_MODULE_0__["default"].getAllTasks(project).forEach((task, index) => {
